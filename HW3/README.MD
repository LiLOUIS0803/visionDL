...
- `--anchor_preset`: anchor configuration, choices are `youzhe`, `default`, `area_light`, and `area`
...
```bash
python -c "from dataset import tif_to_coco; tif_to_coco('./data/train', './data/annotations/train.json')"
```
